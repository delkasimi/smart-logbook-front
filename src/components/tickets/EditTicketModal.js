      ...
      <div className="modal-container">
        ...
        <div className="form-group">
          ...
          >
            ...
            {editedData.fleet &&
              findOptions(columns, "mainAsset", editedData.fleet).map(
                (asset) => (
        ...
        <div className="form-group">
          ...
          >
            ...
            {editedData.system &&
              findOptions(columns, "subSystem", editedData.system).map(
                (subSys) => (
        ...
        <div className="form-group">
          ...
          >
            ...
            {editedData.issueType &&
              findOptions(columns, "issue", editedData.issueType).map(
                (option) => (
                  <option key={option} value={option}>
                    {option}
                  </option>
          ...
          <div className="image-grid">
            {ticketImages.map((image) => (
              <div key={image.media_id}>
                <img
                  src={image.media_url}
                  alt={`Ticket Image ${image.media_id}`}
                />
