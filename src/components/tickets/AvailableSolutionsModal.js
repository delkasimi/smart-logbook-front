...
const AvailableSolutionsModal = ({ formData, onClose, onCreateIssue, onSolutionViewDetails }) => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        ...
        try {
          ...
          .then(data => {
            console.log('Form data to get solutions:', formData); // Debugging
            console.log('solution filter Server response:', data);
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-container">
        ...
        <SolutionDataTable tabledata={availableSolutions} handleViewDetails={handleViewDetails} />
        )} 
