  ...
  return (
    <div className="card">
      <div
        ...
        className="card-header card-header-hover"
      >
        <table className="phases-table phases-table-hover">
          <thead>
            <tr>
              {phaseAttributes.map(({ label }, index) => (
          ...
          <tbody>
            <tr>
              {phaseAttributes.map(({ attribute, type }, index) => (
                <td key={index}>
                  {type === "object"
                    ? Object.entries(phase[attribute]).map(
                        ([key, value], i) => (
